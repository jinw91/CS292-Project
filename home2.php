...
<header>
	...
	<div class="container_12">
		<div class="grid_12">
			<h1 class="text_logo">
            <a href="index.html">Professional&nbsp;Archives</a><!--<img src="site_im/p_a_logo_new.png" alt="">--></h1>
	...
	<div class="container_12">
		<div class="wrapper">
			<div class="grid_4 padbot2">
				<h2>Notifications</h2>
				<div class="box-img"><a href="site-images/image-blank.png" data-gal="prettyPhoto[gallery]" class="lightbox-image"><img src="site-images/1page_img1.jpg" alt=""></a></div>
      ...
      <p><?=$viewers?></p>
			...
			<div class="grid_4 padbot2">
				<h2>Jobs</h2>
				<p class="padtop padbot">Cum sociis natoque penatibus et magnis dis parturi ent montes, nascetur ridiculus mus. Nulla dui. Fusce feugiat malesuada odio. Morbi nunc odio, gravida at, cursus nec, luctus a loremaecena</p>
				<a href="#" class="button1">See all</a>
			</div>
		</div>
